...
function Nav() {
    return (
        <div clas>
             <nav class="top-0 absolute z-50 w-full flex flex-wrap items-center justify-between px-4 py-3 bg-black border-b border-gray-200">  
                ...
                <div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
                    <div class="text-sm lg:flex-grow">
                        ...
                        <p class="block mt-4 lg:inline-block lg:mt-0 text-teal-200 hover:text-white">
                            Blog
                        </p>
                    </div>
                    <div>
